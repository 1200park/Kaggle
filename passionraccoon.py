...
# <font size="3">Until now, We have saved the best overall column and the best overall score, a few feature can be created based on the below criteria:</font>
...
body, _ = nbconvert_script.from_filename("passionraccoon.ipynb")

with open("passionraccoon.py", "w", encoding="utf-8") as f:
    f.write(body)
